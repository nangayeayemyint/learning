...
public class LevelListActivity extends AppCompatActivity {
        ...
        call.enqueue(new Callback<List<SLevel>>() {
            ...
            public void onResponse(Call<List<SLevel>> call, Response<List<SLevel>> response) {
                if(response.isSuccessful()) {
                    ...
                    //Toast.makeText(LevelListActivity.this, ""+levelList.get(1).description, Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    public void showLevels(final List<SLevel> levelList){
        ListView listView = (ListView) findViewById(R.id.listId);
        insertAndPrintTesk();
        //Toast.makeText(LevelListActivity.this, "Size =  "+levelList.size(), Toast.LENGTH_SHORT).show();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String levelId=levelList.get(position).id;
    ...
    class PrintTesk extends AsyncTask<Void, Void, List<LevelRecord>>{
        private LevelDatabase db;
        public PrintTesk(LevelDatabase db){
            this.db = db;
        }
    ...
    public void insertAndPrintTesk(){
        ...
        PrintTesk printTesk = new PrintTesk(db){
            ...
            protected void onPostExecute(List<LevelRecord> levelRecordList) {
                ...
                Toast.makeText(LevelListActivity.this, "Level Record :" + levelRecordList.size(), Toast.LENGTH_SHORT).show();
            }
        };
        printTesk.execute();
    }
